...
var ASM_CONSTS = {
 ...
 808154: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 808237: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 808306: () => { return window.innerWidth; },  
 808336: () => { return window.innerHeight; }
};
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 300884;
